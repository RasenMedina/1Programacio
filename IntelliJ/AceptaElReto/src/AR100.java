...
public class AR100 {
    ...
    public static void main(String[] args) {
        ...
        int  casosTotals = scan.nextInt(); //Llegim el nombre de casos totals
        for (int i=0; i<casosTotals; i++) { //Mirem cada número a tractar
            int numero = scan.nextInt(); //Llegim el número
            if (esRepdigits(numero)) System.out.println("8");
            else if (numero == 6174) System.out.println("0");
            else{
