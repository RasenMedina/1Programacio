...
function executar() {
	...
	if (monedes!=0){
		if (monedes == 1){
			resultat.innerHTML += monedes.toFixed(0) + " moneda de 1 euro<br>";
		}
		else {
			resultat.innerHTML += monedes.toFixed(0) + " monedes de 1 euros<br>";
		}
	}
	...
	if (monedes!=0){
		if (monedes == 1){
			resultat.innerHTML += monedes.toFixed(0) + " moneda de 50 cent<br>";
		}
		else {
	...
	if (monedes!=0){
		if (monedes == 1){
			resultat.innerHTML += monedes.toFixed(0) + " moneda de 20 cent<br>";
		}
		else {
	...
	if (monedes!=0){
		if (monedes == 1){
			resultat.innerHTML += monedes.toFixed(0) + " moneda de 10 cent<br>";
		}
		else {
